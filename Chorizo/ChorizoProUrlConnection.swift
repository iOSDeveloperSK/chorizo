...
typealias Block = (sender: ChorizoProUrlConnection) -> ()

enum ChorizoProUrlConnectionType : String{
  case POST = "POST"
  case GET = "GET"
  case PUT = "PUT"
  case DELETE = "DELETE"
...
class ChorizoProUrlConnection{
  
  private var url: NSURL
  private var type = ChorizoProUrlConnectionType.GET
  ...
  func ofType(type: ChorizoProUrlConnectionType) -> Self{
    self.type = type
    return self
  }
